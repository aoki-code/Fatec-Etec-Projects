...
import controller.ControleSapo;
...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		textAreaFrog1.setBackground(new Color(244, 164, 96));
		...
		textAreaFrog3.setBackground(new Color(244, 164, 96));
		...
		textAreaFrog5.setBackground(new Color(244, 164, 96));
		...
		ControleSapo frogController = new ControleSapo(farol, lbFrog1, lbFrog2, lbFrog3, lbFrog4, lbFrog5, btnIniciar, textArea,lbFinish,textAreaFrog1,textAreaFrog2,textAreaFrog3,textAreaFrog4,textAreaFrog5);
		btnIniciar.addActionListener(frogController);
	}
}